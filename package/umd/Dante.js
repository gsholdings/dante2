(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('immutable'), require('draft-js'), require('react'), require('axios'), require('lodash'), require('draft-convert'), require('draft-js-custom-styles'), require('@emotion/styled'), require('polished'), require('react-dom'), require('react-color'), require('react-select'), require('prismjs'), require('draft-js-prism'), require('draft-js-multidecorators'), require('@emotion/react')) :
  typeof define === 'function' && define.amd ? define(['immutable', 'draft-js', 'react', 'axios', 'lodash', 'draft-convert', 'draft-js-custom-styles', '@emotion/styled', 'polished', 'react-dom', 'react-color', 'react-select', 'prismjs', 'draft-js-prism', 'draft-js-multidecorators', '@emotion/react'], factory) :
  (global.Dante = factory(global.Immutable,global.draftJs,global.React,global.axios,global.lodash,global.draftConvert,global.createStyles,global.styled,global.polished,global.ReactDOM,global.reactColor,global.Select,global.Prism,global.PrismDecorator,global.MultiDecorator,global.emotionTheming));
}(this, (function (Immutable,draftJs,React,axios,lodash,draftConvert,createStyles,styled,polished,ReactDOM,reactColor,Select,Prism,PrismDecorator,MultiDecorator,emotionTheming) { 'use strict';
  ...
  function (_React$Component) {
    ...
    function DanteEditor(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "updateState", function () {
        ...
        var newContentState = draftJs.convertFromRaw(_this.props.content);
        var newEditorState = draftJs.EditorState.push(_this.state.editorState, newContentState, 'insert-characters');
        newEditorState = draftJs.EditorState.moveSelectionToEnd(newEditorState);
    ...
    _createClass(DanteEditor, [{
      ...
      value: function render() {
        ...
        return React.createElement("div", {
          ...
          focus: this.focus //handleDrop={this.handleDrop}
          ,
  ...
  */
  ...
  var AnchorStyle = styled.div(_templateObject, function (props) {
    ...
    return props.arrowPosition ? props.arrowPosition : '50%';
  }, function (props) {
  ...
  function (_React$Component) {
    ...
    function DanteTooltip(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "relocate", function () {
        ...
        var crossedRightBorder = relativeRect.width - left - _this.refs.dante_menu.clientWidth;
  ...
  Dante.defaultProps = {
    ...
    widgets: [ImageBlockConfig(), EmbedBlockConfig(), VideoBlockConfig(), PlaceholderBlockConfig() //CodeBlockConfig()
    ]
  };

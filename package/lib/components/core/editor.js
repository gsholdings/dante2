...
function (_React$Component) {
  ...
  function DanteEditor(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateState", function () {
      ...
      var newContentState = (0, _draftJs.convertFromRaw)(_this.props.content);

      var newEditorState = _draftJs.EditorState.push(_this.state.editorState, newContentState, 'insert-characters');

      newEditorState = _draftJs.EditorState.moveSelectionToEnd(newEditorState);
